    ...
    def make_cpython(self):
        ...
        for cv in cpython_vers:
            ...
            compilers.append({
                ...
                'initial-checked': [],
                'display-name': display_name,
                'display-compile-command': f'{python} prog.py',
                'run-command': [f'/opt/wandbox/cpython-{cv}/bin/{python}', 'prog.py'],
                'runtime-option-raw': True,
                'jail-name': 'melpon2-default',
                'templates': ['cpython'],
            })
    ...
    def make_spidermonkey(self):
        ...
        for cv in spidermonkey_vers:
            ...
            compilers.append({
                ...
                'runtime-option-raw': True,
                'run-command': [f'/opt/wandbox/spidermonkey-{cv}/bin/js', 'prog.js'],
                'jail-name': 'melpon2-default',
